...
class WalletCustomAssetService {
  ...
  static List<WalletAsset> _ethereumPopularAssets(WalletChainConfig chain) {
    return [
      _popularEvmAsset(
        chain,
        folder: 'ethereum',
  ...
  static List<WalletAsset> _bscPopularAssets(WalletChainConfig chain) {
    return [
      _popularEvmAsset(
        chain,
        folder: 'smartchain',
  ...
  static List<WalletAsset> _arbitrumPopularAssets(WalletChainConfig chain) {
    return [
      _popularEvmAsset(
        chain,
        folder: 'arbitrum',
  ...
  static List<WalletAsset> _solanaPopularAssets(WalletChainConfig chain) {
    return [
      WalletAsset.config(
        chainConfig: chain,
        symbol: 'JUP',
  ...
  static List<WalletAsset> _tronPopularAssets(WalletChainConfig chain) {
    return [
      _popularTronAsset(
        chain,
        symbol: 'JST',
  ...
  static WalletAsset _popularEvmAsset(
  ...
  static WalletAsset _popularTronAsset(
    WalletChainConfig chain, {
    required String symbol,
    required String name,
    required int decimals,
  ...
  static String _trustWalletLogo(String folder, String contractAddress) {
  ...
  static String _checksumEvmAddress(String address) {
    ...
    final hash = hex.encode(
      digest.process(Uint8List.fromList(clean.codeUnits)),
    );
