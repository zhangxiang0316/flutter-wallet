...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "authenticateToUnlock": MessageLookupByLibrary.simpleMessage("验证身份以查看敏感信息"),
    ...
    "biometricAuthFailed": MessageLookupByLibrary.simpleMessage("生物识别失败，请使用密码"),
    ...
    "confirmMnemonicBackup": MessageLookupByLibrary.simpleMessage("确认助记词备份"),
    "confirmMnemonicBackupTip": MessageLookupByLibrary.simpleMessage(
      "请输入指定序号的单词，确认你已按正确顺序保存助记词。",
    ),
    ...
    "contactInvalid": MessageLookupByLibrary.simpleMessage("请检查联系人名称、网络和地址"),
    ...
    "customAssetContractAddress": MessageLookupByLibrary.simpleMessage("合约地址"),
    "customAssetContractHint": MessageLookupByLibrary.simpleMessage(
      "请输入当前链上的代币合约或 Mint 地址",
    ),
    ...
    "mnemonicBackupConfirm": MessageLookupByLibrary.simpleMessage("我已安全备份助记词"),
    ...
    "mnemonicNotBackedUpStatus": MessageLookupByLibrary.simpleMessage("未备份"),
    ...
    "networkExplorerApiUrl": MessageLookupByLibrary.simpleMessage("浏览器 API 地址"),
    ...
    "openInExternalBrowser": MessageLookupByLibrary.simpleMessage("外部浏览器打开"),
    ...
    "passwordCacheDisabled": MessageLookupByLibrary.simpleMessage("密码缓存已禁用"),
    ...
    "systemErrorMessage": MessageLookupByLibrary.simpleMessage("操作失败，请稍后重试"),
    ...
    "transactionHistoryEmpty": MessageLookupByLibrary.simpleMessage("暂无交易记录"),
    "transactionHistoryExplorerHint": MessageLookupByLibrary.simpleMessage(
      "应用内暂未查到记录，可到区块浏览器查看该地址。",
    ),
    ...
    "transactionUnknownDirection": MessageLookupByLibrary.simpleMessage("交易"),
    "transactionWalletAddress": MessageLookupByLibrary.simpleMessage("钱包地址"),
    ...
    "unknownErrorMessage": MessageLookupByLibrary.simpleMessage("未知错误，请稍后重试"),
