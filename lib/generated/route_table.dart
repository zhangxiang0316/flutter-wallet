...
class RouteTable {
  ...
  static final List<GetPage> pages = [
    GetPage(name: '/transactionDetail', page: () => TransactionDetailPage()),
    GetPage(name: '/transactionHistory', page: () => TransactionHistoryPage()),
    ...
    GetPage(name: '/walletDetail', page: () => WalletDetailPage()),
    ...
    GetPage(name: '/networkManagement', page: () => NetworkManagementPage()),
