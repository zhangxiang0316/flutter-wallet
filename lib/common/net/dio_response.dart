...
class ResponseData extends BaseResponseData {
  ...
  ResponseData.fromJson(Map<String, dynamic> json) {
    ...
    statusMessage = json['msg'] ?? json['message'];
...
String? dioErrorConversionText(DioException e) {
  ...
  switch (e.type) {
    case DioExceptionType.connectionTimeout:
      str =
          '[DioExceptionType.connectionTimeout] ${StrCommon.connectionTimeout}';
      break;
    ...
    case DioExceptionType.badCertificate:
      str =
          '[DioExceptionType.badCertificate] ${StrCommon.accessCertificateError}';
      break;
    ...
    case DioExceptionType.connectionError:
      str =
          '[DioExceptionType.connectionError] ${StrCommon.connectionIsAbnormal}';
      break;
